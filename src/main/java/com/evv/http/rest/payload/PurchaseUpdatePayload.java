...
/**
 * Класс, содержащий данные, необходимые для обновления сохраненной покупки, в том числе способ оплаты:
...
@Schema(description = "Account or Credit card id must be received and second one must be null")
public class PurchaseUpdatePayload extends PaymentChoiceHolder {
    ...
    public PurchaseUpdatePayload(BigDecimal totalCost, Set<Long> chosenProductIds, Long creditCardId, Long accountId) {
